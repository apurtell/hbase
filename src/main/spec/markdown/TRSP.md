...
TransitionRegionStateProcedure (TRSP) actions for the HBase AssignmentManager. Contains all assign, unassign, move, and reopen procedure steps: creation, candidate selection, dispatch, confirmation, failure handling, crash recovery, meta-blocking, and meta-resume.
