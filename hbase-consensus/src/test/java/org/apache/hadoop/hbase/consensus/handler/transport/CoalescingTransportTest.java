 ...
 * small watermarks, reconnect after the peer goes away, and integrity through the configured
 * payload compressor.
 */
@Tag(SmallTests.TAG)
public class CoalescingTransportTest extends BaseTest {
  ...
  public void reconnect() throws IOException {
    ...
    assertThat(sawTerm3).as("VoteRequest term=3 must arrive after reconnect").isTrue();
  }
  ...
  @Test
  public void rejectSelfDropUnknown() {
    LocalRaftEndpoint epA = LocalRaftEndpoint.newEndpoint();
