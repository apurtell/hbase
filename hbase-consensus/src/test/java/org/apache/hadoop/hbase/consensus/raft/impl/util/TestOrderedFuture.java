...
@Tag(SmallTests.TAG)
public class TestOrderedFuture extends TestBase {
  private final OrderedFuture<Object> future = new OrderedFuture<>();

  @Test
  public void testCannotCancel() {
    assertThrows(UnsupportedOperationException.class, () -> future.cancel(false));
  }

  @Test
  public void testCompleteAfterGetTimeout() throws InterruptedException, ExecutionException {
    try {
  ...
  @Test
  public void testPublicCompleteExceptionallyForbidden() {
  ...
  @Test
  public void testPublicCompleteForbidden() {
  ...
  @Test
  public void testCompleteNullInternal() throws ExecutionException, InterruptedException {
    long commitIndex = 1;
  ...
  @Test
  public void testCompleteValueInternal() throws ExecutionException, InterruptedException {
    long commitIndex = 1;
