...
@Tag(SmallTests.TAG)
public class TestFirewall extends TestBase {
  ...
  @Test
  public void testDropDoesNotAffectOtherEndpoint() {
  ...
  @Test
  public void testDropDoesNotAffectOtherMessageType() {
    RaftEndpoint endpoint = LocalRaftEndpoint.newEndpoint();
  ...
  @Test
  public void testDropAllDoesNotAffectOtherEndpoint() {
    RaftEndpoint endpoint1 = LocalRaftEndpoint.newEndpoint();
    RaftEndpoint endpoint2 = LocalRaftEndpoint.newEndpoint();
  ...
  @Test
  public void testDropMessageTypeForAllEndpoints() {
  ...
  @Test
  public void testDropForAllDoesNotAffectOtherType() {
    firewall.dropMessagesToAll(AppendEntriesRequest.class);
  ...
  @Test
  public void testDropAllOverridesSpecific() {
  ...
  @Test
  public void testAllowReversesDrop() {
    LocalRaftEndpoint endpoint = LocalRaftEndpoint.newEndpoint();
    firewall.dropMessagesTo(endpoint, AppendEntriesRequest.class);
  ...
  @Test
  public void testAllowAllReversesDropAll() {
    LocalRaftEndpoint endpoint = LocalRaftEndpoint.newEndpoint();
    firewall.dropAllMessagesTo(endpoint);
  ...
  @Test
  public void testAllowAllReversesMultipleDrops() {
    LocalRaftEndpoint endpoint = LocalRaftEndpoint.newEndpoint();
    firewall.dropMessagesTo(endpoint, AppendEntriesRequest.class);
    firewall.dropMessagesTo(endpoint, VoteRequest.class);
    firewall.allowAllMessagesTo(endpoint);
