...
/*
   ...
   $ cd MicroRaft && ./mvnw clean test -Dtest=org.apache.hadoop.hbase.consensus.raft.faulttolerance.MajorityFailureTest -DfailIfNoTests=false -Ptutorial
...
public class MajorityFailureTest {
  ...
  public void testMajorityFailure() {
    ...
    String value = "value";
    long commitIndex1 =
      leader.replicate(SimpleStateMachine.applyValue(value)).join().getCommitIndex();
    ...
    long commitIndex2 =
      newLeader.replicate(SimpleStateMachine.applyValue(value)).join().getCommitIndex();
