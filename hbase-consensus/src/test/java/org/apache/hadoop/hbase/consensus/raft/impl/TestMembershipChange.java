...
@Tag(SmallTests.TAG)
public class TestMembershipChange extends TestBase {
  ...
  public void testNewFollowerCatchesUp() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testNewLearnerCatchesUp() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testAddFollowerWithLearner() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testAddSecondLearner() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testAddFollowerWithTwoLearners() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testRejectThirdLearner() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testPromoteLearnerUpdatesMajority() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testPromoteLearnerAllowsAdd() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testSecondPromoteKeepsMajority() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testPromoteFollowerFails() {
    int initialMemberCount = 3;
    group = LocalRaftGroup.start(initialMemberCount);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    try {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testLearnerVotesForNewLeaderAfterPromotionAborted() {
    int initialMemberCount = 3;
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testRemovedMemberCannotRejoin() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testFollowerLeaves() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testNewNodeAfterRemovalCatchesUp() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testNewNodeAppendsMissingEntriesAfterReplacement() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testLeavingLeaderCannotVote() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testLeaderLeavesElectsNew() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testInvalidTypeFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
    try {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testRemoveUnknownFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    RaftNodeImpl leavingFollower = group.getAnyNodeExcept(leader.getLocalEndpoint());
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testAddExistingFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    leader.replicate(applyValue("val")).join();
    try {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testNoTermCommitBlocksChange() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testNopAllowsChangeAfterCommit() {
    // https://groups.google.com/forum/#!msg/raft-dev/t4xj6dJTP6E/d2D9LrWRza8J
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testJoiningInstallsSnapshot() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testLeaderFailDuringLeaveCommits() {
    group = LocalRaftGroup.start(3, TEST_RAFT_CONFIG);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testMultipleAppendsCommitInOrder() {
    RaftConfig config = RaftConfig.newBuilder().setLeaderHeartbeatPeriodMillis(1000).build();
    ...
    RaftNodeImpl newNode1 = group.createNewNode();
    group.dropAppendsAndHeartbeatsTo(leader.getLocalEndpoint(), newNode1.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testSteppingDownRejectsAppends() {
    group = LocalRaftGroup.newBuilder(3).enableNewTermOperation().start();
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testRevertedChangeRetryCommits() {
    group =
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testEvenSizedGroupReducesReplicationQuorum() {
    group =
      LocalRaftGroup.newBuilder(3).setConfig(TEST_RAFT_CONFIG).enableNewTermOperation().start();
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testEvenSizedExtensionRequiresMajorityToCommit() {
    group =
      LocalRaftGroup.newBuilder(3).setConfig(TEST_RAFT_CONFIG).enableNewTermOperation().start();
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testSingleVoterRemovesLearner() {
    group =
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testSingleVoterCannotRemoveSelf() {
    group =
      LocalRaftGroup.newBuilder(2, 1).setConfig(TEST_RAFT_CONFIG).enableNewTermOperation().start();
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    try {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testLeaderCrashDuringLeaveStillCommits() {
    group =
