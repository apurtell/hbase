...
public final class InMemoryRaftStore implements RaftStore {
  ...
  @Override
  public synchronized void
    persistAndFlushTerm(@NonNull RaftTermPersistentState termPersistentState) {
  ...
  public synchronized void persistSnapshotChunk(@NonNull SnapshotChunk snapshotChunk) {
    if (
      snapshotPersistenceState == null
        || snapshotPersistenceState.snapshotIndex != snapshotChunk.getIndex()
    ) {
      snapshotPersistenceState =
        new SnapshotPersistenceState(snapshotChunk.getTerm(), snapshotChunk.getIndex(),
  ...
  public synchronized RestoredRaftState toRestoredRaftState() {
    ...
    return new RestoredRaftState(localEndpointPersistentState, initialGroupMembers,
      termPersistentState, flushedSnapshotEntry, restoredEntries);
  }
}
