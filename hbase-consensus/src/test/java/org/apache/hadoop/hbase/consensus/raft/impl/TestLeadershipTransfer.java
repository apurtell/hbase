...
@Tag(SmallTests.TAG)
public class TestLeadershipTransfer extends TestBase {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferToNullFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    try {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferToNonMemberFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferToLearnerFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferOnFollowerFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferDuringMembershipChangeFails() {
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferWithNoOpsPendingSucceeds() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTransferAfterOpsCommittedSucceeds() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    int term1 = getTerm(leader);
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testTargetCatchupTimeoutFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    RaftNodeImpl follower = group.getAnyNodeExcept(leader.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testDuplicateTransferSucceeds() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    RaftNodeImpl follower = group.getAnyNodeExcept(leader.getLocalEndpoint());
    group.dropAppendsAndHeartbeatsTo(leader.getLocalEndpoint(), follower.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testSecondTransferToDifferentEndpointFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
    RaftNodeImpl follower1 = followers.get(0);
    RaftNodeImpl follower2 = followers.get(1);
    group.dropAppendsAndHeartbeatsTo(leader.getLocalEndpoint(), follower1.getLocalEndpoint());
    leader.replicate(applyValue("val")).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testDuringTransferReplicateFails() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    RaftNodeImpl follower = group.getAnyNodeExcept(leader.getLocalEndpoint());
    group.dropAppendsAndHeartbeatsTo(leader.getLocalEndpoint(), follower.getLocalEndpoint());
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testOldLeaderCannotReplicate() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    RaftNodeImpl follower = group.getAnyNodeExcept(leader.getLocalEndpoint());
    leader.transferLeadership(follower.getLocalEndpoint()).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testNewLeaderCanCommit() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    RaftNodeImpl follower = group.getAnyNodeExcept(leader.getLocalEndpoint());
    leader.transferLeadership(follower.getLocalEndpoint()).join();
  ...
  @Test
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void testInflightOpsCommitDuringTransfer() {
    group = LocalRaftGroup.start(3);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
    List<RaftNodeImpl> followers = group.getNodesExcept(leader.getLocalEndpoint());
    group.dropAppendsAndHeartbeatsTo(leader.getLocalEndpoint(),
