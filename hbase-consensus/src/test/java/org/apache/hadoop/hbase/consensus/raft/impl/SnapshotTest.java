...
public class SnapshotTest extends BaseTest {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderKnowsOthersSnapshot_then_slowFollowerInstallsSnapshotFromLeaderWithoutOptimization() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderKnowsOthersSnapshot_then_slowFollowerInstallsSnapshotFromAllWithOptimization() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderDoesNotKnowOthersSnapshot_then_slowFollowerInstallsSnapshotFromLeaderOnlyWithoutOptimization() {
    when_leaderDoesNotKnowOtherFollowerInstalledSnapshot_then_slowFollowerInstallsSnapshotFromLeaderOnly(
      false);
  }
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderDoesNotKnowOthersSnapshot_then_slowFollowerInstallsSnapshotFromLeaderOnlyWithOptimization() {
    when_leaderDoesNotKnowOtherFollowerInstalledSnapshot_then_slowFollowerInstallsSnapshotFromLeaderOnly(
      true);
  }
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderMissesResponse_then_itAdvancesMatchIndexWithNextResponse_leaderAndFollowers() {
    when_leaderMissesInstallSnapshotResponse_then_itAdvancesMatchIndexWithNextInstallSnapshotResponse(
      true);
  }
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderMissesInstallSnapshotResponses_then_followerInstallsSnapshotsViaOtherFollowers() {
    int entryCount = 50;
    RaftConfig config = RaftConfig.newBuilder().setCommitCountToTakeSnapshot(entryCount).build();
    group = LocalRaftGroup.start(3, config);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderAndSomeFollowersMissInstallSnapshotResponses_then_followerInstallsSnapshotsViaOtherFollowers() {
    int entryCount = 50;
    RaftConfig config = RaftConfig.newBuilder().setCommitCountToTakeSnapshot(entryCount).build();
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_followerMissesTheLastEntryThatGoesIntoTheSnapshot_then_itCatchesUpWithoutInstallingSnapshot() {
    int entryCount = 50;
    RaftConfig config = RaftConfig.newBuilder().setCommitCountToTakeSnapshot(entryCount).build();
    group = LocalRaftGroup.start(3, config);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_followerMissesAFewEntriesBeforeTheSnapshot_then_itCatchesUpWithoutInstallingSnapshot() {
    int entryCount = 50;
    // entryCount * 0.1 - 2
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_followersLastAppendIsMembershipChange_then_itUpdatesRaftNodeStateWithInstalledSnapshot() {
    int entryCount = 50;
    RaftConfig config = RaftConfig.newBuilder().setCommitCountToTakeSnapshot(entryCount).build();
    group = LocalRaftGroup.start(5, config);
    RaftNodeImpl leader = group.waitUntilLeaderElected();
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_slowFollowerReceivesAppendRequestThatDoesNotFitIntoItsRaftLog_then_itTruncatesAppendRequestEntries() {
    ...
    group.dropMessagesTo(leader.getLocalEndpoint(), slowFollower1.getLocalEndpoint(),
      AppendEntriesRequest.class);
    ...
    // committed> ]
    group.dropMessagesTo(leader.getLocalEndpoint(), slowFollower2.getLocalEndpoint(),
      AppendEntriesRequest.class);
    ...
    // committed> ]
    group.allowMessagesTo(leader.getLocalEndpoint(), slowFollower2.getLocalEndpoint(),
      AppendEntriesRequest.class);
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderFailsDuringSnapshotTransfer_then_followerTransfersSnapshotFromNewLeader_leaderOnly() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_leaderFailsDuringSnapshotTransfer_then_followerTransfersSnapshotFromNewLeader_leaderAndFollowers() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_snapshotTriggeredViaSingletonNodeWhenFirstLogEntryNotCommitted_then_snapshotCannotBeTaken() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_snapshotTriggeredViaSingletonNodeWhenFirstLogEntryCommitted_then_snapshotCanBeTaken() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_snapshotTriggeredViaLeaderWhenFirstEntryNotCommitted_then_snapshotCannotBeTaken() {
  ...
  @Timeout(value = 300, unit = TimeUnit.SECONDS)
  public void
    when_snapshotTriggeredViaFollowerMultipleTimesAtSameIndex_then_singleSnapshotIsTaken() {
