 ...
 */
package org.apache.hadoop.hbase.consensus.raft.lifecycle;
 ...
 * startup and termination. These components are {@link RaftNodeExecutor}, {@link StateMachine},
 * {@link RaftModelFactory}, {@link Transport}, {@link RaftStore}, and
 * {@link RaftNodeReportListener}.
 * <p>
 * {@link RaftNode} does not manage the lifecycle of the components provided to it during
 * construction. It only notifies the components that implement this interface.
 * <p>
...
public interface RaftNodeLifecycleAware {
   ...
   * <p>
   * If an exception is thrown, {@link RaftNode} stops its start procedure and immediately
   * terminates itself.
   */
