 ...
 */
package org.apache.hadoop.hbase.consensus.raft.impl.report;
...
public final class RaftLogStatsImpl implements RaftLogStats {
  ...
  public RaftLogStatsImpl(long commitIndex, BaseLogEntry lastLogOrSnapshotEntry,
    SnapshotEntry snapshotEntry, int takeSnapshotCount, int installSnapshotCount,
  ...
  public String toString() {
    return "RaftLogReport{" + "commitIndex=" + commitIndex + ", lastLogOrSnapshotTerm="
      + lastLogOrSnapshotTerm + ", lastLogOrSnapshotIndex=" + lastLogOrSnapshotIndex
      + ", snapshotTerm=" + snapshotTerm + ", snapshotIndex=" + snapshotIndex
      + ", takeSnapshotCount=" + takeSnapshotCount + ", installSnapshotCount="
      + installSnapshotCount + ", followerMatchIndices=" + followerMatchIndices + '}';
  }
}
