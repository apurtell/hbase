...
public final class FollowerState {
  ...
  /**
   * Starts a new request backoff period. No new append entries or install snapshot request will be
   * sent to this follower either until it sends a response or the backoff timeout elapses.
   * <p>
   * Returns the flow control sequence number to be put into the append entries or install snapshot
   * request which is to be sent to the follower.
   */
  ...
  public String toString() {
    return "FollowerState{" + "matchIndex=" + matchIndex + ", nextIndex=" + nextIndex
      + ", backoffRound=" + backoffRound + ", nextBackoffPower=" + nextBackoffPower
      + ", responseTimestamp=" + responseTimestamp + ", flowControlSequenceNumber="
