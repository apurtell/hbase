 ...
 * {@link AppendEntriesSuccessResponseBuilder} interfaces. When an instance of this class is
...
public class DefaultAppendEntriesSuccessResponseOrBuilder
  ...
  @NonNull
  @Override
  public AppendEntriesSuccessResponseBuilder
  ...
  public String toString() {
    String header =
      builder != null ? "AppendEntriesSuccessResponseBuilder" : "AppendEntriesSuccessResponse";
    return header + "{" + "groupId=" + groupId + ", sender=" + sender + ", term=" + term
      + ", lastLogIndex=" + lastLogIndex + ", querySequenceNumber=" + querySequenceNumber
