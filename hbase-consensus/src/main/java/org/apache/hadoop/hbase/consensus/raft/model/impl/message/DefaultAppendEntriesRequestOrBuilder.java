...
/**
 * The default impl of the {@link AppendEntriesRequest} and {@link AppendEntriesRequestBuilder}
...
public class DefaultAppendEntriesRequestOrBuilder
  ...
  public String toString() {
    ...
    return header + "{" + "groupId=" + groupId + ", sender=" + sender + ", term=" + term
      + ", prevLogTerm=" + previousLogTerm + ", prevLogIndex=" + previousLogIndex
      + ", leaderCommitIndex=" + commitIndex + ", logEntries=" + logEntries
