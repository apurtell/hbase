 ...
 * {@link InstallSnapshotResponseBuilder} interfaces. When an instance of this class is created, it
...
public class DefaultInstallSnapshotResponseOrBuilder
  ...
  @NonNull
  @Override
  public InstallSnapshotResponseBuilder
    setRequestedSnapshotChunkIndex(int requestedSnapshotChunkIndex) {
  ...
  public String toString() {
    ...
    return header + "{" + "groupId=" + groupId + ", sender=" + sender + ", term=" + term
      + ", snapshotIndex=" + snapshotIndex + ", requestedSnapshotChunkIndex="
      + requestedSnapshotChunkIndex + ", querySequenceNumber=" + querySequenceNumber
