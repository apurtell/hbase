...
public final class RaftTermState implements RaftTerm {
  ...
  public RaftTermState grantVote(int term, RaftEndpoint votedEndpoint) {
    ...
    assert this.votedEndpoint == null : "current term: " + this.term + " already voted for: "
      + this.votedEndpoint + " new vote to: " + votedEndpoint;
  ...
  public RaftTermState withLeader(RaftEndpoint leaderEndpoint) {
    assert this.leaderEndpoint == null || leaderEndpoint == null : "current term: " + this.term
      + " current " + "leader: " + this.leaderEndpoint + " new " + "leader: " + leaderEndpoint;
    return new RaftTermState(this.term, leaderEndpoint, this.votedEndpoint);
  }

  @Override
  public String toString() {
    return "RaftGroupTerm{" + "term=" + term + ", leaderEndpoint=" + leaderEndpoint
      + ", votedEndpoint=" + votedEndpoint + '}';
  }
}
