...
public class ModifyTableProcedure extends AbstractStateMachineTableProcedure<ModifyTableState> {
      ...
      switch (state) {
        ...
        case MODIFY_TABLE_SNAPSHOT:
          ...
          recoverySnapshotName =
            RecoverySnapshotUtils.generateSnapshotName(getTableName(), timestamp);
  ...
  protected void deserializeStateData(ProcedureStateSerializer serializer) throws IOException {
    ...
    shouldCheckDescriptor = modifyTableMsg.getShouldCheckDescriptor();
    reopenRegions = modifyTableMsg.getReopenRegions();
