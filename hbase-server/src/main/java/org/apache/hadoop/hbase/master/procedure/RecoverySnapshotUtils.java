...
public class RecoverySnapshotUtils {
  ...
  public static boolean isRecoveryEnabled(final MasterProcedureEnv env) {
    return env.getMasterConfiguration().getBoolean(HConstants.SNAPSHOT_BEFORE_DELETE_ENABLED_KEY,
      HConstants.DEFAULT_SNAPSHOT_BEFORE_DELETE_ENABLED)
  ...
  public static long getRecoverySnapshotTtl(final MasterProcedureEnv env) {
    return env.getMasterConfiguration().getLong(HConstants.SNAPSHOT_BEFORE_DELETE_TTL_KEY,
      HConstants.DEFAULT_SNAPSHOT_BEFORE_DELETE_TTL);
  }
